...
*GRIORA_RMS = *Geo::GDAL::Constc::GRIORA_RMS;
...
*GRA_RMS = *Geo::GDAL::Constc::GRA_RMS;
...
*GRA_Sum = *Geo::GDAL::Constc::GRA_Sum;
...
*OF_MULTIDIM_RASTER = *Geo::GDAL::Constc::OF_MULTIDIM_RASTER;
...
*DMD_MULTIDIM_DATASET_CREATIONOPTIONLIST = *Geo::GDAL::Constc::DMD_MULTIDIM_DATASET_CREATIONOPTIONLIST;
*DMD_MULTIDIM_GROUP_CREATIONOPTIONLIST = *Geo::GDAL::Constc::DMD_MULTIDIM_GROUP_CREATIONOPTIONLIST;
*DMD_MULTIDIM_DIMENSION_CREATIONOPTIONLIST = *Geo::GDAL::Constc::DMD_MULTIDIM_DIMENSION_CREATIONOPTIONLIST;
*DMD_MULTIDIM_ARRAY_CREATIONOPTIONLIST = *Geo::GDAL::Constc::DMD_MULTIDIM_ARRAY_CREATIONOPTIONLIST;
*DMD_MULTIDIM_ATTRIBUTE_CREATIONOPTIONLIST = *Geo::GDAL::Constc::DMD_MULTIDIM_ATTRIBUTE_CREATIONOPTIONLIST;
*DMD_OPENOPTIONLIST = *Geo::GDAL::Constc::DMD_OPENOPTIONLIST;
...
*DMD_CREATIONFIELDDATASUBTYPES = *Geo::GDAL::Constc::DMD_CREATIONFIELDDATASUBTYPES;
...
*DCAP_CREATE_MULTIDIMENSIONAL = *Geo::GDAL::Constc::DCAP_CREATE_MULTIDIMENSIONAL;
*DCAP_CREATECOPY = *Geo::GDAL::Constc::DCAP_CREATECOPY;
*DCAP_CREATECOPY_MULTIDIMENSIONAL = *Geo::GDAL::Constc::DCAP_CREATECOPY_MULTIDIMENSIONAL;
*DCAP_MULTIDIM_RASTER = *Geo::GDAL::Constc::DCAP_MULTIDIM_RASTER;
*DCAP_SUBCREATECOPY = *Geo::GDAL::Constc::DCAP_SUBCREATECOPY;
...
*DCAP_GNM = *Geo::GDAL::Constc::DCAP_GNM;
*DCAP_NOTNULL_FIELDS = *Geo::GDAL::Constc::DCAP_NOTNULL_FIELDS;
*DCAP_UNIQUE_FIELDS = *Geo::GDAL::Constc::DCAP_UNIQUE_FIELDS;
*DCAP_DEFAULT_FIELDS = *Geo::GDAL::Constc::DCAP_DEFAULT_FIELDS;
*DCAP_NOTNULL_GEOMFIELDS = *Geo::GDAL::Constc::DCAP_NOTNULL_GEOMFIELDS;
*DCAP_NONSPATIAL = *Geo::GDAL::Constc::DCAP_NONSPATIAL;
*DCAP_FEATURE_STYLES = *Geo::GDAL::Constc::DCAP_FEATURE_STYLES;
*DCAP_COORDINATE_EPOCH = *Geo::GDAL::Constc::DCAP_COORDINATE_EPOCH;
*DCAP_MULTIPLE_VECTOR_LAYERS = *Geo::GDAL::Constc::DCAP_MULTIPLE_VECTOR_LAYERS;
*DIM_TYPE_HORIZONTAL_X = *Geo::GDAL::Constc::DIM_TYPE_HORIZONTAL_X;
*DIM_TYPE_HORIZONTAL_Y = *Geo::GDAL::Constc::DIM_TYPE_HORIZONTAL_Y;
*DIM_TYPE_VERTICAL = *Geo::GDAL::Constc::DIM_TYPE_VERTICAL;
*DIM_TYPE_TEMPORAL = *Geo::GDAL::Constc::DIM_TYPE_TEMPORAL;
*DIM_TYPE_PARAMETRIC = *Geo::GDAL::Constc::DIM_TYPE_PARAMETRIC;
*CPLES_BackslashQuotable = *Geo::GDAL::Constc::CPLES_BackslashQuotable;
*CPLES_XML = *Geo::GDAL::Constc::CPLES_XML;
*CPLES_XML_BUT_QUOTES = *Geo::GDAL::Constc::CPLES_XML_BUT_QUOTES;
*CPLES_URL = *Geo::GDAL::Constc::CPLES_URL;
*CPLES_SQL = *Geo::GDAL::Constc::CPLES_SQL;
*CPLES_SQLI = *Geo::GDAL::Constc::CPLES_SQLI;
